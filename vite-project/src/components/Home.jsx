...
const Home = () => {
    ...
    <>
      ...
      <div className="max-w-[1250px] flex items-center mt-9 h-[450px] bg-[#F5F5F580] m-auto justify-around flex-wrap">
        <div>
          ...
          <p className="max-w-[557px] text-sm text-[#727272]">
            We are an online plant shop offering a wide range of trendy plants...
          </p>
      ...
      <div className="flex items-start justify-center mt-9 gap-6">
        ...
        <div className="max-w-[890px]">
          <h1 className="text-3xl font-bold mb-5 text-center">🌿 O'simliklar</h1>
  ...
  <img className=" h-[282px]" src={img7} alt="" />
     ...
     <h1 className="font-bold text-3xl leading-4 tracking-[0%] text-center mt-31">Our Blog Posts</h1>
     <p className="font-normal text-sm leading-6 tracking-[0%] text-center text-[#727272] mt-2">We are an online plant shop offering a wide range of cheap and trendy plants. </p>
<div className="flex items-center justify-center gap-11 mt-7">
    <div>
      <img src={img8} alt="" />
      <div className="w-[268px] h-[167px] bg-[#FBFBFB] p-2">
           <p className="font-medium text-sm leading-4 tracking-[0%] text-[#46A358]">September 12  I Read in 6 minutes</p>
           <h3 className="w-[202px] h-[52px] font-bold text-xl leading-[26px] tracking-[0%]">Top 10 Succulents for Your Home</h3>
           <p className="w-[242px] h-11 font-normal text-sm leading-[22px] tracking-[0%] text-[#727272]">Best in hanging baskets. Prefers medium to high light.</p>
         <div className="flex items-center gap-2">
            <p className="w-[70px] h-4 font-medium text-sm leading-4 tracking-[0%]">Read More</p>
<img src={img9} alt="" />
         </div>
      </div>
    </div>
...
<div className="max-w-[1200px] h-[250px] bg-[#FBFBFB] m-auto mt-21 flex items-center justify-center gap-5">
  <div>
    <img src={img13} alt="" />
    <h2 className="font-bold text-[17px] leading-4 tracking-[0%] text-[#3D3D3D] mt-1">Garden Care</h2>
    <p className="w-[204px] h-[66px] font-normal text-sm leading-[22px] tracking-[0%] mt-1 text-[#727272]">We are an online plant shop offering a wide range of cheap and trendy plants.</p>
  </div>
  ...
  <div>
    <h1 className="text-lg leading-4 tracking-[0%] font-bold">Would you like to join newsletters?</h1>
    <div>
      <input className="w-[354px] h-10 bg-white p-3 shadow-[0px_0px_20px_0px_#0000000F] mt-3" type="text" placeholder="enter your email address..." />
      <button className="w-[85px] h-10 rounded-tr-md rounded-br-md bg-[#46A358] text-white">Join</button>
      <p className=" w-[354px] font-normal text-[13px] leading-[22px] text-[#727272] mt-1">We usually post offers and challenges in newsletter. We’re your online houseplant destination. We offer a wide range of houseplants and accessories shipped directly from our (green)house to yours! </p>
    </div>
  </div>
</div>
<div className=" w-[1200px] h-[88px] bg-[#46A3581A] m-auto">
   <img src={img16} alt="" />
   <div>
    <img src={img17} alt="" />
   </div>
